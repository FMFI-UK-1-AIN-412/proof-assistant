...
initialModel =
    { history =
        History.new
            ...
            -- Direct proof
            --{ proof = FormulaNode Premise { text = "(a->b)", formula = Ok (Impl (Atom "a" []) (Atom "b" [])), index = 1, gui = { showButtons = False, collapsed = False } } (Just (FormulaNode Premise { text = "(b->c)", formula = Ok (Impl (Atom "b" []) (Atom "c" [])), index = 2, gui = { showButtons = False, collapsed = False } } (Just (FormulaNode Premise { text = "a", formula = Ok (Atom "a" []), index = 3, gui = { showButtons = False, collapsed = False } } (Just (FormulaNode (Goal (Just (FormulaNode (Rule (Just (HypotheticalSyllogism 1 2))) { text = "(a->c)", formula = Ok (Impl (Atom "a" []) (Atom "c" [])), index = 5, gui = { showButtons = False, collapsed = False } } (Just (FormulaNode (Rule (Just (ModusPonens 5 3))) { text = "c", formula = Ok (Atom "c" []), index = 6, gui = { showButtons = False, collapsed = False } } Nothing))))) { text = "c", formula = Ok (Atom "c" []), index = 4, gui = { showButtons = False, collapsed = False } } Nothing)))))), breadcrumbs = [] }
            -- Proof by contradiction
            --{ proof = FormulaNode Premise { text = "(a->b)", formula = Ok (Impl (Atom "a" []) (Atom "b" [])), index = 1, gui = { showButtons = False, collapsed = False } } (Just (FormulaNode Premise { text = "(a->-b)", formula = Ok (Impl (Atom "a" []) (Neg (Atom "b" []))), index = 2, gui = { showButtons = False, collapsed = False } } (Just (FormulaNode (Contradiction (Just (FormulaNode (Rule (Just (DoubleNegation 3))) { text = "a", formula = Ok (Atom "a" []), index = 4, gui = { showButtons = False, collapsed = False } } (Just (FormulaNode (Rule (Just (ModusPonens 1 4))) { text = "b", formula = Ok (Atom "b" []), index = 5, gui = { showButtons = False, collapsed = False } } (Just (FormulaNode (Rule (Just (ModusPonens 2 4))) { text = "-b", formula = Ok (Neg (Atom "b" [])), index = 6, gui = { showButtons = False, collapsed = False } } Nothing))))))) { text = "-a", formula = Ok (Neg (Atom "a" [])), index = 3, gui = { showButtons = False, collapsed = False } } Nothing)))), breadcrumbs = [] }
            -- Proof by cases
            --{ proof = FormulaNode Premise { text = "(a->-b)", formula = Ok (Impl (Atom "a" []) (Neg (Atom "b" []))), index = 1, gui = { showButtons = False, collapsed = False } } (Just (FormulaNode (Goal (Just (FormulaNode (Rule (Just (ImplicationRemoval 1))) { text = "(-a|-b)", formula = Ok (Disj (Neg (Atom "a" [])) (Neg (Atom "b" []))), index = 3, gui = { showButtons = False, collapsed = False } } (Just (CasesNode { text = "-a", formula = Ok (Neg (Atom "a" [])), index = 4, gui = { showButtons = False, collapsed = False } } (Just (FormulaNode (Rule (Just (Conjuction 4 4))) { text = "(-a&-a)", formula = Ok (Conj (Neg (Atom "a" [])) (Neg (Atom "a" []))), index = 5, gui = { showButtons = False, collapsed = False } } (Just (FormulaNode (Rule (Just (Addition 5))) { text = "((-a&-a)|-b)", formula = Ok (Disj (Conj (Neg (Atom "a" [])) (Neg (Atom "a" []))) (Neg (Atom "b" []))), index = 6, gui = { showButtons = False, collapsed = False } } Nothing)))) { text = "-b", formula = Ok (Neg (Atom "b" [])), index = 7, gui = { showButtons = False, collapsed = False } } (Just (FormulaNode (Rule (Just (Addition 7))) { text = "((-a&-a)|-b)", formula = Ok (Disj (Conj (Neg (Atom "a" [])) (Neg (Atom "a" []))) (Neg (Atom "b" []))), index = 8, gui = { showButtons = False, collapsed = False } } Nothing))))))) { text = "(((-a&-a)|-b))", formula = Ok (Disj (Conj (Neg (Atom "a" [])) (Neg (Atom "a" []))) (Neg (Atom "b" []))), index = 2, gui = { showButtons = False, collapsed = False } } Nothing)), breadcrumbs = [] }
            -- First order logic
            -- { proof = FormulaNode Premise { text = "\\forall x P(x)", formula = Ok (ForAll "x" (Atom "P" ([Var "x"]))), index = 1, gui = { showButtons = False, collapsed = False } } (Just (FormulaNode Premise { text = "\\forall x (P(x) -> Q(x))", formula = Ok (ForAll "x" (Impl (Atom "P" ([Var "x"])) (Atom "Q" ([Var "x"])))), index = 2, gui = { showButtons = False, collapsed = False } } (Just (FormulaNode (Goal (Just (FormulaNode (Generalization "x0" (Just (FormulaNode (Rule (Just (FirstOrderRemoveUniversalQunatifier 1))) { text = "P(x0)", formula = Ok (Atom "P" ([Var "x0"])), index = 5, gui = { showButtons = False, collapsed = False } } (Just (FormulaNode (Rule (Just (FirstOrderRemoveUniversalQunatifier 2))) { text = "(P(x0) -> Q(x0))", formula = Ok (Impl (Atom "P" ([Var "x0"])) (Atom "Q" ([Var "x0"]))), index = 6, gui = { showButtons = False, collapsed = False } } (Just (FormulaNode (Rule (Just (ModusPonens 6 5))) { text = "Q(x0)", formula = Ok (Atom "Q" ([Var "x0"])), index = 7, gui = { showButtons = False, collapsed = False } } Nothing))))))) { text = "\\forall x Q(x)", formula = Ok (ForAll "x" (Atom "Q" ([Var "x"]))), index = 4, gui = { showButtons = False, collapsed = False } } Nothing))) { text = "\\forall x Q(x)", formula = Ok (ForAll "x" (Atom "Q" ([Var "x"]))), index = 3, gui = { showButtons = False, collapsed = False } } Nothing)))), breadcrumbs = [] }
            }
    }
